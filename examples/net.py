...
class AlexNet(BL.CChainMixin, chainer.Chain):
    def __init__(self, n_out):
        ...
        self.n_out = n_out
        with self.init_scope():
            self.conv1 = BL.ConvPoolBNBST(1, 10, 5, stride=1, pad=0, pksize=3, pstride=2)
            ...
            # self.fc6 = BL.BinaryLinearBNBST(40, 10)
            # self.fc7 = BL.BinaryLinearBNBST(10, 10)
    ...
    def param_names(self):
        # in this case, n_units and n_out define the model
        return 'AlexNet{}'.format(self.n_out)
